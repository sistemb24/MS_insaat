    ...
    <section className="mx-auto flex max-w-7xl flex-col gap-4">
      <header className="rounded-[var(--radius-panel)] border border-[var(--grid-border)] bg-[var(--surface-container-lowest)] p-5">
        <p className="text-xs font-semibold uppercase tracking-wide text-[var(--primary)]">
          Firma, finans, rol ve denetim
        </p>
        <div className="mt-2 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h1 className="text-2xl font-semibold tracking-normal">Ayarlar</h1>
            <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--on-surface-variant)]">
              P0 sistem yönetimi yüzeyi aktif tenant/firma/dönem bağlamını,
              finans varsayılanlarını, rol matrisini ve audit kapsamını tek
...
function ContextPanel({
  ...
  return (
    <article className="rounded-[var(--radius-panel)] border border-[var(--grid-border)] bg-[var(--surface-container-lowest)]">
      ...
      <dl className="grid gap-0 divide-y divide-[var(--grid-border)]">
        {rows.map((row) => (
          <div
            className="grid min-h-[var(--data-row-height)] grid-cols-[180px_1fr] items-center gap-3 px-4 py-2 text-sm"
            key={row.label}
          >
            <dt className="text-[var(--on-surface-variant)]">{row.label}</dt>
...
function FinancePanel({
  ...
  return (
    <section
      ...
      className="overflow-hidden rounded-[var(--radius-panel)] border border-[var(--grid-border)] bg-[var(--surface-container-lowest)]"
    >
      <div className="border-b border-[var(--grid-border)] px-4 py-3">
      ...
      <div className="border-t border-[var(--grid-border)] px-4 py-3">
      ...
      <div className="grid gap-4 p-4 lg:grid-cols-[1fr_220px]">
        <div className="grid gap-3">
          <dl className="grid gap-2 sm:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-low)] p-3">
              <dt className="text-xs font-semibold text-[var(--on-surface-variant)]">
                Durum
              </dt>
                ...
                {overview.capabilities.map((capability) => (
                  <tr key={capability.label}>
                    ...
                    <td className="px-4 py-3">
                      <span className="rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-low)] px-2 py-1 text-xs font-semibold">
                        {capability.status}
                      </span>
                    </td>
                  </tr>
        ...
        <aside className="rounded-[var(--radius-panel)] border border-[var(--grid-border)] bg-[var(--surface-container-low)] p-4">
          ...
          <div className="mt-4 grid gap-3">
            <label className="grid gap-1 text-sm font-medium">
              ...
              <input
                className="rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-white px-3 py-2 font-mono text-sm text-[var(--on-surface)]"
          ...
          <div className="mt-3 rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-lowest)] px-3 py-2 text-xs font-semibold text-[var(--on-surface-variant)]">
          ...
          <button
            className="mt-4 w-full rounded-[var(--radius-control)] border border-[var(--primary)] bg-[var(--primary)] px-3 py-2 text-sm font-semibold text-white transition hover:opacity-90"
...
function BankIntegrationPanel({
  ...
  return (
    ...
    >
      {pendingPartialApproval ? (
        <div className="border-b border-[var(--grid-border)] bg-[var(--surface-container-low)] p-4" role="dialog" aria-label="Parçalı mutabakat onayı">
          ...
          <div className="mt-3 flex gap-2">
            <button className="rounded-[var(--radius-control)] border border-[var(--grid-border)] px-3 py-1.5 text-xs font-semibold" onClick={() => setPendingPartialApproval(undefined)} type="button">Vazgeç</button>
            <button className="rounded-[var(--radius-control)] bg-[var(--primary)] px-3 py-1.5 text-xs font-semibold text-white" onClick={() => { onCreatePartialCashBankMovementFromBankTransaction(pendingPartialApproval.bankTransactionId, pendingPartialApproval.cashBankMovementId); setPendingPartialApproval(undefined); }} type="button">Kısmi Mutabakatı Onayla</button>
          </div>
        </div>
      ) : null}
      <div className="border-b border-[var(--grid-border)] px-4 py-3">
      ...
      <div className="grid gap-3 p-4 md:grid-cols-[220px_1fr_auto] md:items-end">
        <label className="grid gap-1 text-sm font-medium">
          Banka
          <select
            className="rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-white px-3 py-2 text-sm text-[var(--on-surface)]"
        ...
        <button
          className="rounded-[var(--radius-control)] border border-[var(--primary)] bg-[var(--primary)] px-3 py-2 text-sm font-semibold text-white transition hover:opacity-90"
          onClick={onTestConnection}
          type="button"
        >
      ...
      <div className="grid gap-3 px-4 pb-4 md:grid-cols-[220px_220px_1fr] md:items-end">
        ...
        {bankSyncDateRangeNotice ? (
          <p className="text-xs font-semibold text-[var(--on-surface-variant)] md:col-span-3">
        ...
        >
          ...
          <tbody className="divide-y divide-[var(--grid-border)]">
            {overview.connections.length ? (
                ...
                <tr key={connection.id}>
                  ...
                  <td className="px-4 py-3">
                    <button
                      ...
                      className="rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-low)] px-2 py-1 text-xs font-semibold text-[var(--on-surface-variant)] transition hover:bg-[var(--primary-fixed)]"
              ...
              <tr>
                <td className="px-4 py-4 text-[var(--on-surface-variant)]" colSpan={7}>
                      ...
                      <div className="grid min-w-[260px] gap-2">
                        {manualCandidates.length ? (
                          <>
                            ...
                            <label className="grid gap-1 text-xs font-semibold text-[var(--on-surface-variant)]">
                              <span>Manuel Eşleştirme</span>
                              <select
                                aria-label={`Manuel eşleşme seçimi ${transaction.description}`}
                                className="rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-white px-2 py-1 text-xs text-[var(--on-surface)]"
                                onChange={(event) =>
                                  onManualMatchSelectionChange(
                                    transaction.id,
                                    event.target.value,
                            ...
                            <button
                              ...
                              className="rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-low)] px-2 py-1 text-xs font-semibold text-[var(--on-surface-variant)] transition hover:bg-[var(--primary-fixed)] disabled:cursor-not-allowed disabled:opacity-60"
        ...
        >
          ...
          <tbody className="divide-y divide-[var(--grid-border)]">
            {filteredLedgerReconciliationIssues.length ? (
              filteredLedgerReconciliationIssues.map((issue) => (
                <tr key={`${issue.bankTransactionId}::${issue.issueType}`}>
                  <td className="px-4 py-3">
                    ...
                    <span className="mt-0.5 block font-mono text-xs text-[var(--on-surface-variant)]">
              ...
              <tr>
                <td className="px-4 py-4 text-[var(--on-surface-variant)]" colSpan={4}>
        ...
        >
          ...
          <tbody className="divide-y divide-[var(--grid-border)]">
            {filteredLedgerFailureAudits.length ? (
              ...
              <tr>
                <td className="px-4 py-4 text-[var(--on-surface-variant)]" colSpan={6}>
      ...
      <div className="flex flex-wrap items-center gap-2 px-4 pb-3">
        ...
        <label className="ml-2 flex items-center gap-2 text-xs font-semibold text-[var(--on-surface-variant)]">
          Hesap
          <select
            aria-label="Ledger hesap filtresi"
            className="h-8 rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-low)] px-2 text-xs font-normal"
        ...
        >
          ...
          <tbody className="divide-y divide-[var(--grid-border)]">
            {cashBankMovementDrafts.length ? (
                    ...
                    {cashBankAccountOptions.length ? (
                      <label className="grid gap-1 text-xs font-semibold text-[var(--on-surface-variant)]">
                        ...
                        <select
                          ...
                          className="min-w-[190px] rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-white px-2 py-1 text-xs text-[var(--on-surface)]"
                          onChange={(event) =>
                            onCashBankAccountSelectionChange(
              ...
              <tr>
                <td className="px-4 py-4 text-[var(--on-surface-variant)]" colSpan={9}>
        ...
        >
          ...
          <tbody className="divide-y divide-[var(--grid-border)]">
            {partialCashBankMovementDrafts.length ? (
              ...
              <tr>
                <td className="px-4 py-4 text-[var(--on-surface-variant)]" colSpan={10}>
        ...
        >
          ...
          <tbody className="divide-y divide-[var(--grid-border)]">
            {overview.matchSuggestions.length ? (
              ...
              <tr>
                <td className="px-4 py-4 text-[var(--on-surface-variant)]" colSpan={8}>
...
function RbacPermissionPanel({ currentRole }: { currentRole: TenantScope["userRole"] }) {
  ...
  return (
    <article className="rounded-[var(--radius-panel)] border border-[var(--grid-border)] bg-[var(--surface-container-lowest)] p-4">
      ...
      <p className="mt-1 text-xs text-[var(--on-surface-variant)]">Mevcut rolün hangi kalıcı mutasyonları çalıştırabildiği.</p>
      <div className="mt-3 grid gap-2 sm:grid-cols-2">
        {rows.map((row) => {
          const allowedRoles = getRbacPermissionRoles(row.permission);
          const allowed = allowedRoles.includes(currentRole);
          return <div className="flex items-center justify-between rounded border border-[var(--grid-border)] px-3 py-2 text-xs" key={row.permission}><span>{row.label}</span><span className={allowed ? "font-semibold text-green-700" : "text-[var(--on-surface-variant)]"}>{allowed ? "İzinli" : "Salt okunur"} · {allowedRoles.join(", ")}</span></div>;
        })}
      </div>
    </article>
  );
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 border-b border-[var(--grid-border)] px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          className="rounded-[var(--radius-control)] border border-[var(--primary)] bg-[var(--primary)] px-3 py-1.5 text-sm font-semibold text-white transition hover:opacity-90"
      ...
      <div className="border-t border-[var(--grid-border)] bg-[var(--surface-container-low)] px-4 py-3">
        <div className="flex flex-wrap gap-2 text-xs font-semibold text-[var(--on-surface-variant)]">
          ...
          {activeUserRoleCounts.map(([role, count]) => (
            <span
              className="rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-lowest)] px-2 py-1"
              key={role}
            >
              Rol {role}: {count}
            </span>
      ...
      <div className="flex flex-wrap items-end gap-2 px-4 pb-3">
        <label className="grid gap-1 text-xs font-semibold text-[var(--on-surface-variant)]">
          ...
          <input
            ...
            className="min-h-9 rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-lowest)] px-3 py-2 text-sm font-medium text-[var(--on-surface)]"
        ...
        {activeUserSearchTerm ? (
          <button
            className="min-h-9 rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-low)] px-3 py-2 text-xs font-semibold text-[var(--on-surface-variant)]"
        ...
        <span className="pb-2 text-xs text-[var(--on-surface-variant)]">
            ...
            {filteredActiveUsers.length ? (
              filteredActiveUsers.map((user) => (
                <tr key={user.id}>
                  ...
                  <td className="px-4 py-3 font-mono text-xs font-semibold">
                    <select aria-label={`Rol ${user.fullName}`} className="rounded border border-[var(--grid-border)] bg-white px-2 py-1" value={user.role} onChange={(event) => onUpdateUserRole(user.id, event.target.value as "admin" | "accounting" | "viewer")}>
        ...
        >
          ...
          <tbody className="divide-y divide-[var(--grid-border)]">
            {filteredInvitations.length ? (
              ...
              <tr>
                <td className="px-4 py-4 text-[var(--on-surface-variant)]" colSpan={5}>
      ...
      <div className="flex flex-wrap items-end gap-2 px-4 pb-3">
        ...
        {auditDateFrom && auditDateTo && auditDateFrom > auditDateTo ? (
          <span className="pb-2 text-xs font-semibold text-red-700" role="alert">
      ...
      {isInvitePanelOpen ? (
        <div
          ...
          className="border-t border-[var(--grid-border)] bg-[var(--surface-container-low)] p-4"
          role="dialog"
        >
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-[1fr_280px_auto] md:items-end">
            ...
            <button
              className="rounded-[var(--radius-control)] border border-[var(--grid-border)] bg-[var(--surface-container-lowest)] px-3 py-2 text-sm font-semibold transition hover:bg-[var(--primary-fixed)]"
  ...
  return (
    <aside className="rounded-[var(--radius-panel)] border border-[var(--grid-border)] bg-[var(--surface-container-lowest)] p-4">
      ...
      <p className="mt-2 text-sm leading-6 text-[var(--on-surface-variant)]">
        ...
        ekranı bu kapsamı görünür kılar; detaylı filtreli audit ekranı sonraki
        dilimde genişletilecektir.
      </p>
      <ul className="mt-4 space-y-2 text-sm">
        {auditScopes.map((item) => (
          <li className="flex gap-2" key={item}>
            <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-[var(--status-process)]" />
            <span>{item}</span>
          </li>
        ))}
      </ul>
